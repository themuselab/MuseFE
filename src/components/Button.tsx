...
const hierarchyStyles: Record<ButtonHierarchy, {
  ...
  primary: {
    ...
    hover: "hover:bg-[#f5f5f51f] hover:border-[#f5f5f533] hover:backdrop-blur-[10.5px] hover:shadow-[0_1px_1.75px_rgba(32,29,31,0.13)]",
    pressed: "active:bg-neutral-900/[0.13] active:border-[#f5f5f533] active:backdrop-blur-[10.5px]",
  ...
  accent: {
    ...
    hover: "hover:bg-neutral-800 hover:text-pink-400 hover:backdrop-blur-[10.5px] hover:shadow-[0_1px_1.75px_rgba(32,29,31,0.13)]",
    pressed: "active:bg-neutral-900 active:text-pink-400",
    disabled: "disabled:bg-neutral-300 disabled:text-neutral-400 disabled:border-transparent disabled:shadow-none",
  },
  destructive: {
    base: "bg-neutral-50 text-error-500 border border-error-500",
    hover: "hover:bg-error-50",
    pressed: "active:bg-error-100 active:text-[#751d15]",
    disabled: "disabled:bg-neutral-300 disabled:text-neutral-400 disabled:border-transparent disabled:shadow-none",
  },
};

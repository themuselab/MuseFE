...
export function CatalogHero() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-end">
      <div className="flex flex-col gap-5 md:gap-6 pt-8 md:pt-16 pb-4 md:pb-12">
        <h1 className="text-display-s md:text-display-l text-neutral-900">
          <DottedChar char="진" /> <DottedChar char="짜" /> <DottedChar char="사" /> <DottedChar char="람" /> 같은 AI 모델
          <br />
          여기로 모이실게요
        </h1>
        <p className="text-heading-s md:text-body-l text-neutral-600 max-w-sm">
          우리 브랜드에 가장 잘 어울리는 모델을 지금 바로 한 눈에 확인해 보세요
        </p>
      </div>
      <div className="flex justify-center md:justify-end">
        <div
          className="relative w-full h-64 md:w-96 md:h-110 rounded-t-full overflow-hidden"
          style={{
            backgroundImage:
